...
import { addCommas } from "./helperUtil"
 ...
 */
export function drawEspBox(x, y, z, w, h, red, green, blue, alpha, phase) {
 ...
 */
export function drawBadEspBox(x, y, z, red, green, blue, alpha, phase = true) // thanks to renderlib, don't need the whole module so I'm not adding it.
{
    Tessellator.pushMatrix()
    GL11.glLineWidth(2.0)
    GlStateManager.func_179129_p() // disableCullFace
...
{
    if(drawBox)
        drawBadEspBox(x+0.5,y,z+0.5,r,g,b, alpha, phase)
